#ifndef __MATPLOTLIBINTEHCPP__
#define __MATPLOTLIBINTEHCPP__
...
namespace matplotlibcpp {
	...
	namespace detail {
		struct _interpreter {
			...
			PyObject *s_python_function_interactive;
			...
			_interpreter() {
				...
				s_python_function_interactive = PyObject_GetAttrString(pymod, "interactive");
				...
				if (       !PyFunction_Check(s_python_function_show)
					...
					|| !PyFunction_Check(s_python_function_interactive)
...
// 	//-----------------------------------------------------------------------------------
// 	//------------------Adding the ability to call draw() -------------------------------
// 	//-----------------------------------------------------------------------------------
	inline void interactive(bool flag)
	{
		PyObject* pyflag = flag ? Py_True : Py_False;
		...
		PyObject* res = PyObject_CallObject(detail::_interpreter::get().s_python_function_interactive, args);
		if(!res) throw std::runtime_error("Call to interactive() failed.");
